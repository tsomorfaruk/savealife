                    ...
                    <div id="container-mix" class="be-user-wrapper row">
                        @foreach($posts as $post)
                                        <div class="mix category-1 custom-column-5">
                                            <div class="be-user-block style-2">
                                                ...
                                                <a href="#" class="be-use-name">{{$post->id}}</a>
                        ...
                        {{--@foreach($donor_list as $donor)
                            @foreach($donor as $donor_description)
                                @foreach($donor_description->user->postdonor as $postdonors)
                                    @if($postdonors->status == 1)
                                        <div class="mix category-1 custom-column-5">
                                            <div class="be-user-block style-2">
                                                <a class="be-ava-user style-2" href="#">
                                                    <img src="{{asset('/')}}assets/img/blood_drop.jpg" alt="">
                                                ...
                                                <a href="#" class="be-use-name">{{$donor_description->user->name}}</a>
                                                <p class="be-user-info">{{$donor_description->user->city}} </p>
                                                <div class="be-text-tags">
                                                    <h3 style="color: #f00;">
                                                        <b>{{$donor_description->user->blood_group}}</b>
                                                    </h3>
                                                </div>
                                                <a class="btn btn-danger size-2 hover-1 cancel-donor" href="#"
                                                   id="@foreach($donor_description->user->postdonor as $postdonors){{$postdonors->id}}@endforeach">Cancel</a>
                                            </div>
                                        </div>
                                    @endif
                                @endforeach
                                    ...
                                    @if($postdonors->status == 2)
                                        <div class="mix category-2 custom-column-5">
                                            <div class="be-user-block style-2">
                                                ...
                                                <a href="#"
                                                   class="be-use-name">{{$donor_description->user->name}}</a>
                                                <p class="be-user-info">{{$donor_description->user->city}} </p>
                                                <div class="be-text-tags">
                                                    <h3 style="color: #f00;">
                                                        <b>{{$donor_description->user->blood_group}}</b>
                                                ...
                                                <a style="float: left" class="btn color-1 size-2 hover-1 complete-donor" href="#"
                                                   id="@foreach($donor_description->user->postdonor as $postdonors){{$postdonors->id}}@endforeach">Complete</a>
                                                <a style="float: right" class="btn btn-danger size-2 hover-1 cancel-donor" href="#"
                                                   id="@foreach($donor_description->user->postdonor as $postdonors){{$postdonors->id}}@endforeach">Cancel</a>
                                            </div>
                                        </div>
                                    @endif
                        ...
                        @foreach($donor_list as $donor)
                            @foreach($donor as $donor_description)
                                @foreach($donor_description->user->postdonor as $postdonors)
                                    @if($postdonors->status == 3)
                                        <div class="mix category-3 custom-column-5">
                                            <div class="be-user-block style-2">
                                                <a class="be-ava-user style-2" href="#">
                                                    <img src="{{asset('/')}}assets/img/blood_drop.jpg"
                                                         alt="">
                                                </a>
                                                <div class="be-user-counter">
                                                    <div class="c_number">10</div>
                                                ...
                                                <a class="btn color-1 size-2 hover-1 completed-donor"
                                                   href="#"
                                                   id="">Completed</a>
                                            </div>
                                        </div>
                                    ...
                                    @if($postdonors->status == 0)
                                        <div class="mix category-4 custom-column-5">
                                            <div class="be-user-block style-2">
                                                ...
                                                <a class="btn color-1 size-2 hover-1 canceled-donor"
                                                   href="#"
                                                   id="">Canceled</a>
                                            </div>
                                        </div>
