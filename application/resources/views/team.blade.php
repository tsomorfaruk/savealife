                ...
                <div class="row">
                    <div class="col-ml-12 col-xs-6 col-sm-6 col-md-3">
                        <div class="team-entry">
                            <a href="blog-detail-2.html"><img height="260px" width="260px"  src="{{asset('/')}}assets/img/Atik.png" alt=""></a>
                    ...
                    <div class="col-ml-12 col-xs-6 col-sm-6 col-md-3">
                        <div class="team-entry">
                            <a href="blog-detail-2.html"><img class="img-responsive img-full" src="{{asset('/')}}assets/img/ilias shah.jpg"
                                                              alt=""></a>
                            <h4 class="team-name">Ilias Shah</h4>
                            <div class="team-position">
                                <a href="blog-detail-2.html" class="be-post-tag">Design Guru</a>
                            </div>
                            <div class="team-social">
                    ...
                    <div class="col-ml-12 col-xs-6 col-sm-6 col-md-3">
                        <div class="team-entry">
                            <a href="blog-detail-2.html"><img height="260px" width="260px" src="{{asset('/')}}assets/img/omor.jpg"
                                                              alt=""></a>
                    ...
                    <div class="col-ml-12 col-xs-6 col-sm-6 col-md-3">
                        <div class="team-entry">
                            <a href="blog-detail-2.html"><img height="260px" width="260px" src="{{asset('/')}}assets/img/ashraful.jpg" height="20px" alt=""></a>
