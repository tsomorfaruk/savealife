...
<!-- Mirrored from demo.nrgthemes.com/projects/nrgnetwork/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Feb 2019 09:20:10 GMT -->
...
<div class="be-loader">
	...
	<header>
		<div class="container-fluid custom-container">
			<div class="row no_row row-header">
				<div class="brand-be">
					<a href="index-2.html">
						<img class="logo-c active be_logo"  src="{{asset('/')}}assets/img/logo.png" alt="logo">
				...
				<div class="login-header-block">
					<div class="login_block">
						<a class="btn-login btn color-1 size-2 hover-2" href="{{ route('login') }}" ><i class="fa fa-user"></i>
						Log in</a>
					</div>	
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-md-10">
					<div id="container-mix"  class="row _post-container_">
						...
						<div class="category-3 mix custom-column-5">
							<div class="be-post">
								<a href="{{asset('/')}}assets/page3.html" class="be-img-block">
	            ...
	            <div class="swiper-wrapper">
	            	...
	            	<div class="swiper-slide" data-val="1">
						<a href="gallery.html">
	            		 	 ...
	            		 	 <img class="img-responsive img-full" src="{{asset('/')}}assets/img/f2.jpg" alt="">
	            	 </a></div>
	            	<div class="swiper-slide" data-val="2">
						<a href="gallery.html">

	            		 	 <img class="img-responsive img-full" src="{{asset('/')}}assets/img/f3.jpg" alt="">
	            	 </a></div>
	            	<div class="swiper-slide" data-val="3">
						<a href="gallery.html">

	            		 	 <img class="img-responsive img-full" src="{{asset('/')}}assets/img/f4.jpg" alt="">
	            	 </a></div>
	            	<div class="swiper-slide" data-val="4">
						<a href="gallery.html">

	            		 	 <img class="img-responsive img-full" src="{{asset('/')}}assets/img/f5.jpg" alt="">
	            	 </a></div>
	            	<div class="swiper-slide" data-val="5">
						<a href="gallery.html">

	            		 	 <img class="img-responsive img-full" src="{{asset('/')}}assets/img/f6.jpg" alt="">
	            	 </a></div>
	            	<div class="swiper-slide" data-val="6">
						<a href="gallery.html">

	            		 	 <img class="img-responsive img-full" src="{{asset('/')}}assets/img/f7.jpg" alt="">
	            	 </a></div>
	            	<div class="swiper-slide" data-val="7">
						<a href="gallery.html">

	            		 	 <img class="img-responsive img-full" src="{{asset('/')}}assets/img/f8.jpg" alt="">
	            	 </a></div>
	            	<div class="swiper-slide" data-val="8">
						<a href="gallery.html">

	            		 	 <img class="img-responsive img-full" src="{{asset('/')}}assets/img/f9.jpg" alt="">
	            	 </a></div>
	            	<div class="swiper-slide" data-val="9">
						<a href="gallery.html">

	            		 	 <img class="img-responsive img-full" src="{{asset('/')}}assets/img/f10.jpg" alt="">
	            	 </a></div>
	            	<div class="swiper-slide" data-val="10">
						<a href="gallery.html">

	            		 	 <img class="img-responsive img-full" src="{{asset('/')}}assets/img/f11.jpg" alt="">
	            	 </a></div>
	            	<div class="swiper-slide" data-val="11">
						<a href="gallery.html">

	            		 	 <img class="img-responsive img-full" src="{{asset('/')}}assets/img/f12.jpg" alt="">
	            	 </a></div>
	            	<div class="swiper-slide" data-val="12">
						<a href="gallery.html">

	            		 	 <img class="img-responsive img-full" src="{{asset('/')}}assets/img/f13.jpg" alt="">
	            	 </a></div>
	            	<div class="swiper-slide" data-val="13">
						<a href="gallery.html">

	            		 	 <img class="img-responsive img-full" src="{{asset('/')}}assets/img/f14.jpg" alt="">
	            	 </a></div>
	            	<div class="swiper-slide" data-val="14">
						<a href="gallery.html">

	            		 	 <img class="img-responsive img-full" src="{{asset('/')}}assets/img/f15.jpg" alt="">
	            	 </a></div>
	            	<div class="swiper-slide" data-val="15">
						<a href="gallery.html">

	            		 	 <img class="img-responsive img-full" src="{{asset('/')}}assets/img/f16.jpg" alt="">
	            	 </a></div>
	            	<div class="swiper-slide" data-val="16">
						<a href="gallery.html">

	            		 	 <img class="img-responsive img-full" src="{{asset('/')}}assets/img/f17.jpg" alt="">
	            	 </a></div>
	            	<div class="swiper-slide" data-val="17">
						<a href="gallery.html">

	            		 	 <img class="img-responsive img-full" src="{{asset('/')}}assets/img/f18.jpg" alt="">
	            	 </a></div>
	            	<div class="swiper-slide" data-val="18">
						<a href="gallery.html">

	            		 	 <img class="img-responsive img-full" src="{{asset('/')}}assets/img/f19.jpg" alt="">
	            	 </a></div>
	            	<div class="swiper-slide" data-val="19">
						<a href="gallery.html">

	            		 	 <img class="img-responsive img-full" src="{{asset('/')}}assets/img/f1.jpg" alt="">
	            	 </a></div>
				...
				<div class="row">	
					...
					<div class="col-md-3 galerry">
						<div class="footer-block">					
							...
							<a href="blog-detail-2.html"><img src="{{asset('/')}}assets/img/g1.jpg" alt=""></a>
							<a href="blog-detail-2.html"><img src="{{asset('/')}}assets/img/g2.jpg" alt=""></a>
							<a href="blog-detail-2.html"><img src="{{asset('/')}}assets/img/g3.jpg" alt=""></a>
							<a href="blog-detail-2.html"><img src="{{asset('/')}}assets/img/g4.jpg" alt=""></a>
							<a href="blog-detail-2.html"><img src="{{asset('/')}}assets/img/g5.jpg" alt=""></a>
							<a href="blog-detail-2.html"><img src="{{asset('/')}}assets/img/g6.jpg" alt=""></a>
							<a href="blog-detail-2.html"><img src="{{asset('/')}}assets/img/g7.jpg" alt=""></a>
							<a href="blog-detail-2.html"><img src="{{asset('/')}}assets/img/g8.jpg" alt=""></a>
							<a href="blog-detail-2.html"><img src="{{asset('/')}}assets/img/g9.jpg" alt=""></a>
							<a href="blog-detail-2.html"><img src="{{asset('/')}}assets/img/g10.jpg" alt=""></a>
							<a href="blog-detail-2.html"><img src="{{asset('/')}}assets/img/g11.jpg" alt=""></a>
							<a href="blog-detail-2.html"><img src="{{asset('/')}}assets/img/g12.jpg" alt=""></a>
						</div>
					</div>
					<div class="col-md-3">
						<div class="footer-block">
			...
			<div class="row">
				<div class="col-md-8 col-md-push-2 col-lg-6 col-lg-push-3  large-popup-content">
					<div class="row">
						...
						<form action="{{route('login')}}" class="popup-input-search" method="POST">
						@csrf
						<div class="col-md-6">
							<input class="input-signtype" type="email" required="" name="email
	...
	<!-- SCRIPTS	 -->
	<script src="{{asset('/')}}assets/script/jquery-2.1.4.min.js"></script>
	<script src="{{asset('/')}}assets/script/jquery-ui.min.js"></script>
	<script src="{{asset('/')}}assets/script/bootstrap.min.js"></script>		
	<script src="{{asset('/')}}assets/script/idangerous.swiper.min.js"></script>
	<script src="{{asset('/')}}assets/script/jquery.mixitup.js"></script>
	<script src="{{asset('/')}}assets/script/jquery.viewportchecker.min.js"></script>
	<script src="{{asset('/')}}assets/script/filters.js"></script>
	<script src="{{asset('/')}}assets/script/global.js"></script>
	</body>

<!-- Mirrored from demo.nrgthemes.com/projects/nrgnetwork/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Feb 2019 09:21:06 GMT -->
</html>