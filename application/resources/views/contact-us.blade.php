...
<!-- Mirrored from demo.nrgthemes.com/projects/nrgnetwork/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Feb 2019 09:24:55 GMT -->
<head>
    ...
    <!--[if lt IE 10]>
    <link rel="stylesheet" type="text/css" href="{{asset('/')}}assets/style/ie-9.css" />
    <![endif]-->
    <!--[if lt IE 9]>
...
<div id="content-block">
    <div class="head-bg style-2">
        <div class="head-bg-img"><img class="center-image" src="{{asset('/')}}img/bg-4.jpg" alt=""></div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 galerry">
                    <div class="footer-block">
                        ...
                        <a href="blog-detail-2.html"><img src="{{asset('/')}}img/g1.jpg" alt=""></a>
                        <a href="blog-detail-2.html"><img src="{{asset('/')}}img/g2.jpg" alt=""></a>
                        <a href="blog-detail-2.html"><img src="{{asset('/')}}img/g3.jpg" alt=""></a>
                        <a href="blog-detail-2.html"><img src="{{asset('/')}}img/g4.jpg" alt=""></a>
                        <a href="blog-detail-2.html"><img src="{{asset('/')}}img/g5.jpg" alt=""></a>
...
<div class="theme-config">
    ...
    <div class="open"><img src="{{asset('/')}}img/icon-134.png" alt=""></div>
</div>
...
<script src="{{asset('/')}}assets/script/isotope.pkgd.min.js"></script>
...
<!-- Mirrored from demo.nrgthemes.com/projects/nrgnetwork/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Feb 2019 09:24:57 GMT -->
</html>
--}}